...
public:
    ...
    void setupUi(QMainWindow *FiatShamir)
    {
        ...
        resultadosw->setGeometry(QRect(430, 140, 581, 191));
        ...
        nuevo->setGeometry(QRect(540, 370, 99, 27));
        nuevo->setFont(font2);
    ...
    void retranslateUi(QMainWindow *FiatShamir)
    {
        ...
        nuevo->setText(QApplication::translate("FiatShamir", "NUEVO", 0));
    } // retranslateUi
